...
const immutableCollectionItemsAndKeysOfChecker = (
    ...
    if (itemError) {
        return new Error(
            `Invalid prop \'${propName}\' supplied to \'${componentName}\'. Validation failed. Wrong item type: ${itemError.message}`,
        );
    }

    if (keyError) {
        return new Error(
            `Invalid prop \'${propName}\' supplied to \'${componentName}\'. Validation failed. Wrong key type: ${keyError.message}`,
        );
    }
};
...
const immutableIterableOfChecker = (itemPropTypeChecker, props, propName, componentName) => {
    ...
    if (!(props[propName] instanceof Immutable.Iterable)) {
        return new Error(
            `Invalid prop \'${propName}\' supplied to \'${componentName}\'. Validation failed. Expected: Immutable.Iterable, type: ${typeof props[
                propName
            ]}`,
        );
    }

    return immutableCollectionItemsAndKeysOfChecker(itemPropTypeChecker, null, props, propName, componentName);
};
...
const immutableListOfChecker = (itemPropTypeChecker, props, propName, componentName) => {
    ...
    if (!(props[propName] instanceof Immutable.List)) {
        return new Error(
            `Invalid prop \'${propName}\' supplied to \'${componentName}\'. Validation failed. Expected: Immutable.List, type: ${typeof props[
                propName
            ]}`,
        );
    }
...
const immutableSetOfChecker = (itemPropTypeChecker, props, propName, componentName) => {
    ...
    if (!(props[propName] instanceof Immutable.Set)) {
        return new Error(
            `Invalid prop \'${propName}\' supplied to \'${componentName}\'. Validation failed. Expected: Immutable.Set, type: ${typeof props[
                propName
            ]}`,
        );
    }
...
const immutableMapOfChecker = (itemPropTypeChecker, keyPropTypeChecker, props, propName, componentName) => {
    if (!props[propName]) {
        return;
    }
    ...
    if (!(props[propName] instanceof Immutable.Map)) {
        return new Error(
            `Invalid prop \'${propName}\' supplied to \'${componentName}\'. Validation failed. Expected: Immutable.Map, type: ${typeof props[
                propName
            ]}`,
        );
    }
...
const customPropTypes = {
    ...
    immutableMapOf: (itemPropTypeChecker, keyPropTypeChecker) =>
        makeIsRequired((...args) => immutableMapOfChecker(itemPropTypeChecker, keyPropTypeChecker, ...args)),
};
